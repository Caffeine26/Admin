                ...
                <v-card-text>
                    <v-row dense>
                        ...
                        <v-col cols="12">
                            ...
                            <v-img v-if="form.image" :src="previewImage" max-width="120" max-height="120"
            ...
            <v-col v-for="category in filteredCategories" :key="category.id" cols="12" sm="6" md="4">
                <v-card>
                    ...
                    <v-card-title class="text-h6">
                        {{ category.name_khmer }} / {{ category.name_english }}
                    </v-card-title>
...
export default defineComponent({
    ...
    setup() {
        ...
        const sortLetter = ref('All'); // <- added
        const letters = ref([
        ...
        const previewImage = computed(() =>
            form.image ? URL.createObjectURL(Array.isArray(form.image) ? form.image[0] : form.image) : ''
        );
        ...
        const filteredCategories = computed(() => {
            ...
            if (sortLetter.value && sortLetter.value !== 'All') {
        ...
        const submitForm = async () => {
            ...
            try {
                ...
                console.error(error);
                snackbar.message = 'Failed to save category!';
                snackbar.color = 'error';
                snackbar.show = true;
            }
        };
        ...
        const deleteCategory = async (id: number) => {
            if (deleteDialog.categoryId === null) return;
            try {
