...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/Customization/edit/[id]': RouteRecordInfo<'/Customization/edit/[id]', '/Customization/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    '/Feedbacks/': RouteRecordInfo<'/Feedbacks/', '/Feedbacks', Record<never, never>, Record<never, never>>,
    '/home': RouteRecordInfo<'/home', '/home', Record<never, never>, Record<never, never>>,
    '/kaching': RouteRecordInfo<'/kaching', '/kaching', Record<never, never>, Record<never, never>>,
    '/login': RouteRecordInfo<'/login', '/login', Record<never, never>, Record<never, never>>,
    '/OrderManagement/': RouteRecordInfo<'/OrderManagement/', '/OrderManagement', Record<never, never>, Record<never, never>>,
    '/OrderManagement/[id]/edit': RouteRecordInfo<'/OrderManagement/[id]/edit', '/OrderManagement/:id/edit', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    '/OrderManagement/create': RouteRecordInfo<'/OrderManagement/create', '/OrderManagement/create', Record<never, never>, Record<never, never>>,
    '/OrderManagement/table': RouteRecordInfo<'/OrderManagement/table', '/OrderManagement/table', Record<never, never>, Record<never, never>>,
